...
function addTab()
{
    if(!document.getElementById("WME-Quick-HN") && W.selectionManager.getSelectedFeatures().length > 0 && W.selectionManager.getSelectedFeatures()[0].model.type === 'segment')
    {
        ...
        document.getElementById('_housenumber').value = counter;
...
function addHN4()
{
    ...
    setFocus({interval: 0, alpha: true});
}
...
function sethn(options = {}) {
    ...
    {
        counter = +document.getElementById('_housenumber').value + options.interval;
        if (document.getElementById('_housenumber') !== null ) {
            updateNumberField(counter);
            letterIndex = 0;
            updateLetterField(letterIndex);
        }
...
function updateNumberField(value) {
    document.getElementById('_housenumber').value = value;
}
